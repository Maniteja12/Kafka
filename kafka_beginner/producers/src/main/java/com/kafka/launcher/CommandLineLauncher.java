...
import static com.kafka.producer.MessageProducer.propsMap;
...
public class CommandLineLauncher {
    ...
    public static void publishMessage(MessageProducer messageProducer, String input){
        ...
        switch (noOfTokens){
            case 1:
                messageProducer.publishMessage(null,stringTokenizer.nextToken());
                break;
            case 2:
                messageProducer.publishMessage(stringTokenizer.nextToken(),stringTokenizer.nextToken());
                break;
            default:
                break;
        }
